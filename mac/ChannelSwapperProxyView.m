...
extern ChannelSwapperController *gChannelSwapperController;
...
*/
@implementation ChannelSwapperProxyView
...
- (void)layoutSubviews
{
	NSLog(@"ChannelSwapper in layout");
}
...
- (void)viewDidChangeBackingProperties
	...
	*/
	...
	NSLog(@"ChannelSwapper viewDidChangeBackingProperties, scale: %f", scaleFactor);
...
- (void)drawRect:(NSRect)rect 
{
	...
	if ( ! [NSThread isMainThread] ) 
	{
		...
		[gChannelSwapperController performSelectorOnMainThread:@selector(updateProxy:)
							   withObject:NULL
							waitUntilDone:NO];
		 */
	...
	NSLog(@"ChannelSwapper drawRect, w: %f, h: %f, x: %f, y: %f, scale: %f", rect.size.width, rect.size.height, rect.origin.x, rect.origin.y, scaleFactor);
	...
	*/
	...
	[gChannelSwapperController updateCursor];
}

@end

// end ChannelSwapperProxyView.m
